...
[Tags]: rhythmic gymnastics, ribbon apparatus, split l, another tag, and another	https://vidmuse-dev.sandcdn.com/user/0/assets/images/90b7a1.jpg	https://vidmuse-dev.sandcdn.com/user/0/assets/videos/8f858f.mp4	https://vidmuse-dev.sandcdn.com/user/0/assets/videos/e0040a.mp4`;
...
if (papaParseFailed) {
  ...
  console.log("Did NOT recover, using PapaParse data.");
}
