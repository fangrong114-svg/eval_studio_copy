...
import { VoteRecord, EvaluationItem, VotingStats } from '../types';
...
const ResultsScreen: React.FC<ResultsScreenProps> = ({ votes, items, onReset, userName, modelNames, onGoToDashboard }) => {
  // Calculate Stats
